...
# Author: JFF
# Last Modified: 2022-12-26 13:57:23
# Description:
# Usage:
# Input:
# Output:
...
eQTac_correlation(pre_score, exp_file, result_file)
...
eQTac_permutation(pre_score, exp_file, n_permutation, permutation_plist_file)
